...
public class Questions {
	...
	public String sandwichFilling(String sandwich) {
	        ...
	        String s = sandwich.toLowerCase();
	        String s2 = sandwich.toLowerCase();

	        if (s.contains("bread")) {
	            s = s.replaceFirst("bread", "");
	            if (s.contains("bread")) {
	                s = s.replaceFirst("bread", "");
	            } else {return ""; }
	        } else {return ""; }

	        s2 = s2.substring(s2.indexOf("bread") + 5);
	        s2 = s2.substring(0, s2.indexOf("bread"));
	...
	/**
	 * Given a string and an int n, return a string that removes n letters fromj
	...
	public String nMid(String input, int n) {
		...
		String start = input.substring(0, middle - (n/2));
		String end = input.substring(middle + (n/2) + 1);
		return start + end;
